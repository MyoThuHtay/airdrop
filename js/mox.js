...
const sttaddr = "0x2fd38C1A195A0994944e302bE78D604D3a6cf22f";
...
contract.methods.lastairdrop(addr).call( (err, res) => {
    a = res;
  });
  return(a);
}
...
const sttaddr = "0x5691C0c4dAEE68DA705616d72dCD0794c42eEBB3";
